...
state_root="${workspace}/.panthera-phone-policy-eval-diagnostic-state"
log_root="${workspace}/logs/panthera-phone-policy-eval-diagnostic"
...
nohup bash "${workspace}/run_lab_panthera_phone_policy_eval_diagnostic.sh" \
