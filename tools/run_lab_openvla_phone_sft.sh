...
export PANTHERA_SFT_DATASET_MARKER="${workspace}/state/panthera-phone-sft-dataset-state/dataset.ok"
export PANTHERA_SFT_RLDS_MARKER="${workspace}/state/panthera-phone-sft-rlds-state/rlds.ok"
export PANTHERA_SFT_SMOKE_MARKER="${workspace}/state/panthera-phone-openvla-sft-smoke-state/train.ok"
export PANTHERA_SFT_RUN_ROOT="${workspace}/runs/panthera-phone-openvla-sft"
export PANTHERA_SFT_STATE_ROOT="${PANTHERA_SFT_STATE_ROOT:-${workspace}/state/panthera-phone-openvla-sft-state}"
