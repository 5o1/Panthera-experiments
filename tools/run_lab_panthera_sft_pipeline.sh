...
state_root="${workspace}/.panthera-single-sft-pipeline-state"
dataset_state="${workspace}/.panthera-single-sft-dataset-state"
dataset_runner="${workspace}/run_lab_robotwin_panthera_sft_dataset.sh"
rlds_runner="${workspace}/run_lab_panthera_sft_rlds.sh"
train_runner="${workspace}/run_lab_openvla_sft_step_smoke.sh"
