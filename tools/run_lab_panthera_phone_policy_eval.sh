...
rlinf_overlay="${workspace}/panthera-rlinf-overlay"
robotwin_overlay="${workspace}/panthera-robotwin-overlay"

export PANTHERA_EVAL_STATE_ROOT="${PANTHERA_EVAL_STATE_ROOT:-${workspace}/.panthera-phone-policy-eval-state}"
...
export PANTHERA_EVAL_CONFIG_MARKER="${PANTHERA_EVAL_CONFIG_MARKER:-${workspace}/.panthera-phone-eval-config-state/config.ok}"
export PANTHERA_EVAL_TRAIN_MARKER="${PANTHERA_EVAL_TRAIN_MARKER:-${workspace}/.panthera-phone-openvla-sft-state/train.ok}"
export PANTHERA_EVAL_TRAIN_STATE="${PANTHERA_EVAL_TRAIN_STATE:-${workspace}/.panthera-phone-openvla-sft-state}"
