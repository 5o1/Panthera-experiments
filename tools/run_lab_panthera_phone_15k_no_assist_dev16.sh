...
export PANTHERA_EVAL_STATE_ROOT="${workspace}/.panthera-phone-15k-no-assist-h18-dev16-state"
export PANTHERA_EVAL_LOG_ROOT="${workspace}/logs/panthera-phone-15k-no-assist-h18-dev16"
export PANTHERA_EVAL_TRACE_DIR="${PANTHERA_EVAL_STATE_ROOT}/trajectory-traces"
export PANTHERA_EVAL_SEED_SOURCE="${workspace}/panthera-rlinf-overlay/seeds/panthera_phone_vertical_eval_seeds.json"
...
export PANTHERA_EVAL_TRAJECTORIES=16
export PANTHERA_EVAL_GPUS=1,2
# This is diagnostic: it must never unlock the final held-out seeds.
