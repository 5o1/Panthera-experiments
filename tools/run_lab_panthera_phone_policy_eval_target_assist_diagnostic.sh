...
export PANTHERA_EVAL_STATE_ROOT="${workspace}/.panthera-phone-policy-eval-25x7-target-assist-diagnostic-state"
export PANTHERA_EVAL_LOG_ROOT="${workspace}/logs/panthera-phone-policy-eval-25x7-target-assist-diagnostic"
...
export PANTHERA_EVAL_TRAJECTORIES=1
export PANTHERA_EVAL_GPUS=1
