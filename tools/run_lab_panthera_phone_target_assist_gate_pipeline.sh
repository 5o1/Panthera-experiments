...
diagnostic_seeds="${workspace}/overlays/rlinf/seeds/panthera_phone_vertical_diagnostic_seeds.json"
heldout_seeds="${workspace}/overlays/rlinf/seeds/panthera_phone_vertical_eval_seeds.json"
...
date --iso-8601=seconds >"${workspace}/state/panthera-phone-target-assist-gates.ok"
