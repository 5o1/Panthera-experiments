...
export PANTHERA_EVAL_STATE_ROOT="${workspace}/.panthera-phone-target-assist-stage-diagnostic-state"
export PANTHERA_EVAL_LOG_ROOT="${workspace}/logs/panthera-phone-target-assist-stage-diagnostic"
export PANTHERA_EVAL_TRACE_DIR="${PANTHERA_EVAL_STATE_ROOT}/trajectory-traces"
export PANTHERA_EVAL_SEED_SOURCE="${workspace}/panthera-rlinf-overlay/seeds/panthera_phone_vertical_assist_stage_diagnostic_seeds.json"
