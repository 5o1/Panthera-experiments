...
export PANTHERA_POLICY_MODEL="${workspace}/runs/panthera-phone-openvla-sft/panthera-phone-wide-v3-vertical-sft-25x7-30000steps"
export PANTHERA_EVAL_STATE_ROOT="${workspace}/.panthera-phone-30k-stabilized-route-regression-state"
export PANTHERA_EVAL_LOG_ROOT="${workspace}/logs/panthera-phone-30k-stabilized-route-regression"
export PANTHERA_EVAL_TRACE_DIR="${PANTHERA_EVAL_STATE_ROOT}/trajectory-traces"
export PANTHERA_EVAL_SEED_SOURCE="${workspace}/panthera-rlinf-overlay/seeds/panthera_phone_vertical_30k_triggered_seeds.json"
