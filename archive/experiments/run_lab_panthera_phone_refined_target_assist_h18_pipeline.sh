...
run_gate \
  policy-eval-25x7-refined-target-assist-h18-dev16 \
  "${workspace}/panthera-rlinf-overlay/seeds/panthera_phone_vertical_eval_seeds.json"

run_gate \
  policy-eval-25x7-refined-target-assist-h18-final16 \
  "${workspace}/panthera-rlinf-overlay/seeds/panthera_phone_vertical_final_seeds_v2.json"

date --iso-8601=seconds >"${workspace}/.panthera-phone-refined-target-assist-h18-gates.ok"
