...
export PANTHERA_SFT_MAX_STEPS=15000
export PANTHERA_SFT_LEARNING_RATE=0.00005
export PANTHERA_SFT_LR_WARMUP_STEPS=0
export PANTHERA_SFT_NUM_STEPS_BEFORE_DECAY=20000
...
export PANTHERA_SFT_STATE_ROOT="${workspace}/.panthera-phone-openvla-sft-25x7-low-lr-15k-state"
export PANTHERA_SFT_RUN_ID=panthera-phone-wide-v3-vertical-sft-25x7-15000steps-lr5e5-nowarmup
