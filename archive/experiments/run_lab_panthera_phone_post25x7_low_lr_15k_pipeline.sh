...
model="${workspace}/runs/panthera-phone-openvla-sft/panthera-phone-wide-v3-vertical-sft-25x7-15000steps-lr5e5-nowarmup"
...
run_gate \
  policy-eval-25x7-low-lr-15k-stabilized-h18-dev16 \
  "${workspace}/panthera-rlinf-overlay/seeds/panthera_phone_vertical_eval_seeds.json"

run_gate \
  policy-eval-25x7-low-lr-15k-stabilized-h18-final16 \
  "${workspace}/panthera-rlinf-overlay/seeds/panthera_phone_vertical_final_seeds_v2.json"

date --iso-8601=seconds >"${workspace}/.panthera-phone-25x7-low-lr-15k-gates.ok"
