...
export PANTHERA_EVAL_STATE_ROOT="${workspace}/.panthera-phone-15k-release-gate-h18-dev16-state"
export PANTHERA_EVAL_LOG_ROOT="${workspace}/logs/panthera-phone-15k-release-gate-h18-dev16"
