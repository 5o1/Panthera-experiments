...
export PANTHERA_EVAL_STATE_ROOT="${workspace}/.panthera-phone-target-assist-route-regression-state"
export PANTHERA_EVAL_LOG_ROOT="${workspace}/logs/panthera-phone-target-assist-route-regression"
